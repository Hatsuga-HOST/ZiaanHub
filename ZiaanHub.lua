-- ZiaanHub Key System (Premium Glass UI) -- By ZiaanStore Â© 2025 -- Compact Glassmorphism Theme -- CONFIG 
...
ShowKeyBtn.MouseButton1Click:Connect(function() 
    playSound(ClickSoundId) -- Added click sound
...
Footer.Text = "ZiaanStore Â© 2025 | Edition v2.1" 
...
local function setupHoverEffect(button, normalColor, hoverColor, normalStroke, hoverStroke) 
    button.MouseEnter:Connect(function() 
        tween(button, 0.2, { BackgroundColor3 = hoverColor, Position = button.Position - UDim2.new(0, 0, 0.01, 0), Size = button.Size + UDim2.new(0, 0, 0.01, 0) }) 
        if hoverStroke then 
            tween(button.UIStroke, 0.2, {Color = hoverStroke, Thickness = 2}) 
        end 
    end) 
    button.MouseLeave:Connect(function() 
        tween(button, 0.2, { BackgroundColor3 = normalColor, Position = button.Position + UDim2.new(0, 0, 0.01, 0), Size = button.Size - UDim2.new(0, 0, 0.01, 0) }) 
...
setupHoverEffect(VerifyBtn, Color3.fromRGB(60, 130, 240), Color3.fromRGB(80, 150, 255), Color3.fromRGB(120, 180, 255), Color3.fromRGB(140, 200, 255)) 
setupHoverEffect(CloseBtn, Color3.fromRGB(50, 65, 100), Color3.fromRGB(70, 85, 120), Color3.fromRGB(100, 150, 220), Color3.fromRGB(120, 170, 240)) 
...
local function toast(msg, ok) 
    if ok then
        playSound(SuccessSoundId) -- Success sound
    else
        playSound(FailSoundId) -- Fail sound
    end
...
local function confirmExit() 
    ...
    setupHoverEffect(YesBtn, Color3.fromRGB(220, 80, 80), Color3.fromRGB(240, 100, 100), Color3.fromRGB(250, 120, 120), Color3.fromRGB(255, 140, 140)) 
    setupHoverEffect(NoBtn, Color3.fromRGB(70, 140, 230), Color3.fromRGB(90, 160, 250), Color3.fromRGB(120, 180, 255), Color3.fromRGB(140, 200, 255)) 
